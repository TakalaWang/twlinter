// Project config file support (.twlinter.toml).
//
...
/// Config file name.
const CONFIG_FILENAME: &str = ".twlinter.toml";
...
impl ProjectConfig {
    /// Discover and parse the nearest .twlinter.toml.
    ///
...
/// Walk from start upward looking for .twlinter.toml.
